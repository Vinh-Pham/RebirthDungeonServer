/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 102af271b94a69ed8771f4a9bd83d75d)
...
interface __BaseEnv_CloudflareBindings {
	...
	EMAIL: SendEmail;
	APP_QUEUE: Queue;
	CACHE_RATE_LIMIT: RateLimit;
	QUEUE_RATE_LIMIT: RateLimit;
	AUTH_RATE_LIMIT: RateLimit;
	REFRESH_RATE_LIMIT: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "EMAIL_FROM_NAME" | "JWT_ACCESS_SECRET">> {}
}
