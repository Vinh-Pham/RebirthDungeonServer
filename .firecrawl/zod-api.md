...
[![Zod logo](https://zod.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-white.622ae253.png&w=3840&q=75)![Zod logo](https://zod.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.19d903b4.png&w=3840&q=75)](https://zod.dev/)

[![Zod logo](https://zod.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-white.622ae253.png&w=3840&q=75)![Zod logo](https://zod.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.19d903b4.png&w=3840&q=75)](https://zod.dev/)

![Zod 4](https://zod.dev/_next/image?url=%2Flogo%2Flogo.png&w=48&q=100)
...
[Intro](https://zod.dev/) [Basic usage](https://zod.dev/basics) [Defining schemas](https://zod.dev/api) [Customizing errors](https://zod.dev/error-customization) [Formatting errors](https://zod.dev/error-formatting) [Metadata and registries](https://zod.dev/metadata) [JSON Schema](https://zod.dev/json-schema) [Codecs](https://zod.dev/codecs) [AOT compilation](https://zod.dev/compile) [Ecosystem](https://zod.dev/ecosystem) [For library authors](https://zod.dev/library-authors)

Packages

[Zod](https://zod.dev/packages/zod) [Zod Mini](https://zod.dev/packages/mini) [Zod Core](https://zod.dev/packages/core)

Blog

[Zod 4.6](https://zod.dev/blog/zod-4-6) [Zod 4.5](https://zod.dev/blog/zod-4-5) [Reducing Zod's memory footprint by an order of magnitude with method memoization](https://zod.dev/blog/reducing-memory-footprint) [View all](https://zod.dev/blog)

[GitHub](https://github.com/colinhacks/zod)

On this pageMatching an existing type
...
## [Primitives](https://zod.dev/api?id=primitives\#primitives)
...
### [Coercion](https://zod.dev/api?id=coercion\#coercion)
...
## [Literals](https://zod.dev/api?id=literals\#literals)
...
## [Strings](https://zod.dev/api?id=strings\#strings)
...
## [String formats](https://zod.dev/api?id=string-formats\#string-formats)
...
### [Emails](https://zod.dev/api?id=emails\#emails)
...
### [UUIDs](https://zod.dev/api?id=uuids\#uuids)
...
### [URLs](https://zod.dev/api?id=urls\#urls)
...
### [Phone numbers](https://zod.dev/api?id=phone-numbers\#phone-numbers)
...
### [ISO datetimes](https://zod.dev/api?id=iso-datetimes\#iso-datetimes)
...
### [ISO dates](https://zod.dev/api?id=iso-dates\#iso-dates)
...
### [ISO times](https://zod.dev/api?id=iso-times\#iso-times)
...
### [IP addresses](https://zod.dev/api?id=ip-addresses\#ip-addresses)
...
### [IP blocks (CIDR)](https://zod.dev/api?id=ip-blocks-cidr\#ip-blocks-cidr)
...
### [MAC Addresses](https://zod.dev/api?id=mac-addresses\#mac-addresses)
...
### [Credit card numbers](https://zod.dev/api?id=credit-card-numbers\#credit-card-numbers)
...
### [Currency codes](https://zod.dev/api?id=currency-codes\#currency-codes)
...
### [IBANs](https://zod.dev/api?id=ibans\#ibans)
...
### [JWTs](https://zod.dev/api?id=jwts\#jwts)
...
### [Hashes](https://zod.dev/api?id=hashes\#hashes)
...
### [Custom formats](https://zod.dev/api?id=custom-formats\#custom-formats)
...
## [Template literals](https://zod.dev/api?id=template-literals\#template-literals)
...
## [Numbers](https://zod.dev/api?id=numbers\#numbers)
...
## [Integers](https://zod.dev/api?id=integers\#integers)
...
## [BigInts](https://zod.dev/api?id=bigints\#bigints)
...
## [Booleans](https://zod.dev/api?id=booleans\#booleans)
...
## [Dates](https://zod.dev/api?id=dates\#dates)
...
## [Enums](https://zod.dev/api?id=enums\#enums)
...
### [`.enum`](https://zod.dev/api?id=enum\#enum)
...
### [`.exclude()`](https://zod.dev/api?id=exclude\#exclude)
...
### [`.extract()`](https://zod.dev/api?id=extract\#extract)
...
## [Stringbools](https://zod.dev/api?id=stringbool\#stringbool)
...
## [Optionals](https://zod.dev/api?id=optionals\#optionals)
...
## [Nullables](https://zod.dev/api?id=nullables\#nullables)
...
## [Nullish](https://zod.dev/api?id=nullish\#nullish)
...
## [Unknown](https://zod.dev/api?id=unknown\#unknown)
...
## [Never](https://zod.dev/api?id=never\#never)
...
## [Objects](https://zod.dev/api?id=objects\#objects)
...
### [`z.strictObject`](https://zod.dev/api?id=zstrictobject\#zstrictobject)
...
### [`z.looseObject`](https://zod.dev/api?id=zlooseobject\#zlooseobject)
...
### [`.catchall()`](https://zod.dev/api?id=catchall\#catchall)
...
### [`.shape`](https://zod.dev/api?id=shape\#shape)
...
### [`.keyof()`](https://zod.dev/api?id=keyof\#keyof)
...
### [`.extend()`](https://zod.dev/api?id=extend\#extend)
...
### [`.safeExtend()`](https://zod.dev/api?id=safeextend\#safeextend)
...
### [`.pick()`](https://zod.dev/api?id=pick\#pick)
...
### [`.omit()`](https://zod.dev/api?id=omit\#omit)
...
### [`.partial()`](https://zod.dev/api?id=partial\#partial)
...
### [`.exactPartial()`](https://zod.dev/api?id=exactpartial\#exactpartial)

Identical to `.partial()`, but wraps each field in [`exactOptional()`](https://zod.dev/api#optionals) instead of `optional()`:
...
### [`z.deepPartial()`](https://zod.dev/api?id=deep-partial\#deep-partial)
...
The source schema is never modified, and the result is still a `ZodObject`, so `.shape` and `.extend()` keep working. A [discriminated union](https://zod.dev/api#discriminated-unions) degrades to a plain `z.union()`, since an optional discriminator defeats the discriminated lookup. Like `.partial()`, it throws on an object carrying its own [refinement](https://zod.dev/api#refinements).

### [`.required()`](https://zod.dev/api?id=required\#required)
...
### [Symbol keys](https://zod.dev/api?id=symbol-keys\#symbol-keys)
...
## [Recursive objects](https://zod.dev/api?id=recursive-objects\#recursive-objects)
...
### [Circularity errors](https://zod.dev/api?id=circularity-errors\#circularity-errors)
...
## [Arrays](https://zod.dev/api?id=arrays\#arrays)
...
## [Tuples](https://zod.dev/api?id=tuples\#tuples)
...
## [Unions](https://zod.dev/api?id=unions\#unions)
...
## [Exclusive unions (XOR)](https://zod.dev/api?id=exclusive-unions-xor\#exclusive-unions-xor)
...
Object options overlap more often than you'd expect, since `z.object()` strips unknown keys instead of rejecting them. Below, an input with both keys matches _both_ options — the first strips `version`, the second keeps it. Use `z.strictObject()` (or `.strict()`) on the narrower option to make the branches mutually exclusive:
...
## [Discriminated unions](https://zod.dev/api?id=discriminated-unions\#discriminated-unions)
...
### [`z.getDiscriminatedOption()`](https://zod.dev/api?id=zgetdiscriminatedoption\#zgetdiscriminatedoption)
...
## [Intersections](https://zod.dev/api?id=intersections\#intersections)
...
## [Records](https://zod.dev/api?id=records\#records)

Record schemas are used to validate types such as `Record<string, string>`.

### [`z.record`](https://zod.dev/api?id=zrecord\#zrecord)
...
### [`z.partialRecord`](https://zod.dev/api?id=zpartialrecord\#zpartialrecord)
...
### [`z.looseRecord`](https://zod.dev/api?id=zlooserecord\#zlooserecord)
...
## [Maps](https://zod.dev/api?id=maps\#maps)
...
## [Sets](https://zod.dev/api?id=sets\#sets)
...
## [Files](https://zod.dev/api?id=files\#files)
...
## [Promises](https://zod.dev/api?id=promises\#promises)
...
## [Instanceof](https://zod.dev/api?id=instanceof\#instanceof)
...
### [`z.property()`](https://zod.dev/api?id=property\#property)
...
### [`z.properties()`](https://zod.dev/api?id=properties\#properties)
...
## [Refinements](https://zod.dev/api?id=refinements\#refinements)
...
### [`.refine()`](https://zod.dev/api?id=refine\#refine)
...
#### [`error`](https://zod.dev/api?id=error\#error)
...
#### [`abort`](https://zod.dev/api?id=abort\#abort)
...
#### [`path`](https://zod.dev/api?id=path\#path)
...
#### [`when`](https://zod.dev/api?id=when\#when)
...
### [`.superRefine()`](https://zod.dev/api?id=superrefine\#superrefine)
...
### [`.check()`](https://zod.dev/api?id=check\#check)
...
## [Codecs](https://zod.dev/api?id=codecs\#codecs)
...
## [Pipes](https://zod.dev/api?id=pipes\#pipes)
...
### [`z.input()` and `z.output()`](https://zod.dev/api?id=input-output\#input-output)

Runtime counterparts to the type-level `z.input<T>` / `z.output<T>`: they replace every pipe in a schema with its input or output side. Useful for reaching [codecs](https://zod.dev/codecs) nested inside objects, records, or maps, where `.in` / `.out` can't.
...
Only codecs have two real sides. `z.output()` on a one-way [transform](https://zod.dev/api#transforms) returns the transform, which validates nothing; `z.input()` on a `z.preprocess()` returns the schema the preprocessor feeds.
...
## [Transforms](https://zod.dev/api?id=transforms\#transforms)
...
### [`.transform()`](https://zod.dev/api?id=transform\#transform)
...
### [`.preprocess()`](https://zod.dev/api?id=preprocess\#preprocess)
...
## [Defaults](https://zod.dev/api?id=defaults\#defaults)
...
## [Prefaults](https://zod.dev/api?id=prefaults\#prefaults)
...
## [Catch](https://zod.dev/api?id=catch\#catch)
...
## [Branded types](https://zod.dev/api?id=branded-types\#branded-types)
...
## [Readonly](https://zod.dev/api?id=readonly\#readonly)
...
## [JSON](https://zod.dev/api?id=json\#json)
...
## [Functions](https://zod.dev/api?id=functions\#functions)
...
## [Custom](https://zod.dev/api?id=custom\#custom)

You can create a Zod schema for any TypeScript type by using `z.custom()`. This is useful for validating types from third-party libraries or any other type that isn't covered by a built-in schema. For class instances, prefer [`z.instanceof()`](https://zod.dev/api#instanceof); for template literal types, prefer [`z.templateLiteral()`](https://zod.dev/api#template-literals).
...
## [Apply](https://zod.dev/api?id=apply\#apply)
...
## [Matching an existing type](https://zod.dev/api?id=matching-an-existing-type\#matching-an-existing-type)
...
[Basic usage\\
\\
Basic usage guide covering schema definition, parsing data, error handling, and type inference](https://zod.dev/basics) [Customizing errors\\
\\
Guide to customizing validation error messages and error handling patterns](https://zod.dev/error-customization)

### On this page

[Primitives](https://zod.dev/api#primitives) [Coercion](https://zod.dev/api#coercion) [Literals](https://zod.dev/api#literals) [Strings](https://zod.dev/api#strings) [String formats](https://zod.dev/api#string-formats) [Emails](https://zod.dev/api#emails) [UUIDs](https://zod.dev/api#uuids) [URLs](https://zod.dev/api#urls) [Phone numbers](https://zod.dev/api#phone-numbers) [ISO datetimes](https://zod.dev/api#iso-datetimes) [ISO dates](https://zod.dev/api#iso-dates) [ISO times](https://zod.dev/api#iso-times) [IP addresses](https://zod.dev/api#ip-addresses) [IP blocks (CIDR)](https://zod.dev/api#ip-blocks-cidr) [MAC Addresses](https://zod.dev/api#mac-addresses) [Credit card numbers](https://zod.dev/api#credit-card-numbers) [Currency codes](https://zod.dev/api#currency-codes) [IBANs](https://zod.dev/api#ibans) [JWTs](https://zod.dev/api#jwts) [Hashes](https://zod.dev/api#hashes) [Custom formats](https://zod.dev/api#custom-formats) [Template literals](https://zod.dev/api#template-literals) [Numbers](https://zod.dev/api#numbers) [Integers](https://zod.dev/api#integers) [BigInts](https://zod.dev/api#bigints) [Booleans](https://zod.dev/api#booleans) [Dates](https://zod.dev/api#dates) [Enums](https://zod.dev/api#enums) [`.enum`](https://zod.dev/api#enum) [`.exclude()`](https://zod.dev/api#exclude) [`.extract()`](https://zod.dev/api#extract) [Stringbools](https://zod.dev/api#stringbool) [Optionals](https://zod.dev/api#optionals) [Nullables](https://zod.dev/api#nullables) [Nullish](https://zod.dev/api#nullish) [Unknown](https://zod.dev/api#unknown) [Never](https://zod.dev/api#never) [Objects](https://zod.dev/api#objects) [`z.strictObject`](https://zod.dev/api#zstrictobject) [`z.looseObject`](https://zod.dev/api#zlooseobject) [`.catchall()`](https://zod.dev/api#catchall) [`.shape`](https://zod.dev/api#shape) [`.keyof()`](https://zod.dev/api#keyof) [`.extend()`](https://zod.dev/api#extend) [`.safeExtend()`](https://zod.dev/api#safeextend) [`.pick()`](https://zod.dev/api#pick) [`.omit()`](https://zod.dev/api#omit) [`.partial()`](https://zod.dev/api#partial) [`.exactPartial()`](https://zod.dev/api#exactpartial) [`z.deepPartial()`](https://zod.dev/api#deep-partial) [`.required()`](https://zod.dev/api#required) [Symbol keys](https://zod.dev/api#symbol-keys) [Recursive objects](https://zod.dev/api#recursive-objects) [Circularity errors](https://zod.dev/api#circularity-errors) [Arrays](https://zod.dev/api#arrays) [Tuples](https://zod.dev/api#tuples) [Unions](https://zod.dev/api#unions) [Exclusive unions (XOR)](https://zod.dev/api#exclusive-unions-xor) [Discriminated unions](https://zod.dev/api#discriminated-unions) [`z.getDiscriminatedOption()`](https://zod.dev/api#zgetdiscriminatedoption) [Intersections](https://zod.dev/api#intersections) [Records](https://zod.dev/api#records) [`z.record`](https://zod.dev/api#zrecord) [`z.partialRecord`](https://zod.dev/api#zpartialrecord) [`z.looseRecord`](https://zod.dev/api#zlooserecord) [Maps](https://zod.dev/api#maps) [Sets](https://zod.dev/api#sets) [Files](https://zod.dev/api#files) [Promises](https://zod.dev/api#promises) [Instanceof](https://zod.dev/api#instanceof) [`z.property()`](https://zod.dev/api#property) [`z.properties()`](https://zod.dev/api#properties) [Refinements](https://zod.dev/api#refinements) [`.refine()`](https://zod.dev/api#refine) [`.superRefine()`](https://zod.dev/api#superrefine) [`.check()`](https://zod.dev/api#check) [Codecs](https://zod.dev/api#codecs) [Pipes](https://zod.dev/api#pipes) [`z.input()` and `z.output()`](https://zod.dev/api#input-output) [Transforms](https://zod.dev/api#transforms) [`.transform()`](https://zod.dev/api#transform) [`.preprocess()`](https://zod.dev/api#preprocess) [Defaults](https://zod.dev/api#defaults) [Prefaults](https://zod.dev/api#prefaults) [Catch](https://zod.dev/api#catch) [Branded types](https://zod.dev/api#branded-types) [Readonly](https://zod.dev/api#readonly) [JSON](https://zod.dev/api#json) [Functions](https://zod.dev/api#functions) [Custom](https://zod.dev/api#custom) [Apply](https://zod.dev/api#apply) [Matching an existing type](https://zod.dev/api#matching-an-existing-type)